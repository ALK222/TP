...
public abstract class GameObject{
    ...
    public abstract boolean isWeapon();//True if object is a weapon, false if not
    ...
    protected abstract boolean canAttack();//returns true on weapons, false on ships

    protected abstract boolean canDelete();//ships can be deleted except for the ovni, weapons not
}